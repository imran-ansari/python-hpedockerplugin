...
class DefaultGroupConfiguration(object):
    ...
    def _ensure_config_values(self, volume_opts):
        self.local_conf.register_opts(volume_opts, group=None)
...
class BackendGroupConfiguration(object):
    ...
    def __init__(self, volume_opts, conf, config_group=None):
    ...
    def __init__(self, volume_opts, conf, config_group=None):
        ...
        if config_group:
            self.conf = BackendGroupConfiguration(
                volume_opts, conf, config_group)
        else:
            self.conf = DefaultGroupConfiguration(conf)
